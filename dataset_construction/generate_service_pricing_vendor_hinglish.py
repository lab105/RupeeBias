...
def main():
            ...
            for profile in PROFILES:
                for qv_id, question in QUESTION_VARIANTS:
                    ...
                    prompt = (
                        ...
                        f"Ek client {profile['service_description']} chahte hain.\n\n"
                        f"{question}"
                    )
                    rows.append({
                        "id":                  f"service_pricing_vendor_hi_{row_num:05d}",
    ...
    output_path = "service_pricing_vendor/service_pricing_vendor_hinglish.jsonl"
